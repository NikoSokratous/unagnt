...
import { UnagntExplorerProvider } from "./explorer";
...
export function activate(context: vscode.ExtensionContext) {
  ...
  const explorer = new UnagntExplorerProvider(serverUrl, apiKey);
  vscode.window.registerTreeDataProvider("unagntExplorer", explorer);

  context.subscriptions.push(
    vscode.commands.registerCommand("unagnt.refresh", () => explorer.refresh())
  );

  context.subscriptions.push(
    vscode.commands.registerCommand("unagnt.validateWorkflow", async () => {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("unagnt.runAgent", async () => {
